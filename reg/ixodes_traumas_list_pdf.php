...
*/
    ...
    class TPDF_SESes extends FPDFEx
    {
        function TPDF_SESes()
        {
            $this->FPDFEx('Ixodes Messages Report', 'L');
            $this->Open();
        ...
        function Header()
        {
            ...
            if ( $this->PageNo() == 1 )
            {
                $vX = $this->GetX();
                $vY = $this->GetY();
                $this->Cell($vWidth, $vHeight, iconv('utf-8', 'cp1251','Журнал "Укусы клещей"'), '', 0, 'C');
                $this->SetX($vX);
            ...
            {
                $this->Cell($vWidth, $vHeight, iconv('utf-8', 'cp1251','Журнал "Укусы клещей" с ').$this->BegDate.iconv('utf-8', 'cp1251',' г. по ').$this->EndDate.iconv('utf-8', 'cp1251',' г. / стр.').$this->PageNo(), '', 0, 'R');
                $this->Ln($vHeight*2);
            }
