...
*/
    ...
    class TPDF_PhoneMessages extends FPDFEx
    {
        function TPDF_PhoneMessages()
        {
        ...
        function Header()
        {
            ...
            if ( $this->PageNo() == 1 )
            {
                $vX = $this->GetX();
                $vY = $this->GetY();
                $this->Cell($vWidth, $vHeight, iconv('utf-8', 'cp1251','Журнал телефонограмм'), '', 0, 'C');
                $this->SetX($vX);
            ...
            {
                $this->Cell($vWidth, $vHeight, iconv('utf-8', 'cp1251','Журнал телефонограмм с ').$this->BegDate.iconv('utf-8', 'cp1251',' г. по ').$this->EndDate.iconv('utf-8', 'cp1251',' г. / стр.').$this->PageNo(), '', 0, 'R');
                $this->Ln($vHeight*2);
            }
...
//    header('Accept-Ranges: bytes');
    $vDoc->Output('PhoneMessages.pdf', 'I');
?>
