  ...
  #####################################################################
    ...
    class TData extends TBaseView
    {
        function GetTable()
        {
            ...
            $vTab->AddTableAction('печать',  CompoundURL('ixodes_traumas_list.pdf', $vFilter));
...
// =======================================================================
    ...
    $vTemplate->compile('reg/ixodes_traumas_list.html');
...
//        CopyParam($vFilter, $vValues, 'Order');
        Redirect( CompoundURL('ixodes_traumas_list.html', $vFilter) );
    }
