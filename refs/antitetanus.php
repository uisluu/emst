...
*/
    ...
    class TData extends TBaseView
    {
        function GetTable()
        {
            ...
            $vTab =& new TTable('rb_antitetanus', '*', '', 'name', 'id');
            $vTab->AddColumn('name',      'Наименование');
            $vTab->AddRowAction('изменить', 'antitetanus_edit.html?id=');
            $vTab->AddTableAction('новая запись',  'antitetanus_edit.html');
...
//  $vView->form = $vRenderer->toObject();
    $vTemplate->compile('refs/antitetanus.html');
