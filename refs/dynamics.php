...
*/
    ...
    class TData extends TBaseView
    {
        function GetTable()
        {
            ...
            $vTab =& new TTable('rb_dynamics', '*', '', 'name', 'id');
            $vTab->AddColumn('name',      'Наименование');
            $vTab->AddRowAction('изменить', 'dynamic_edit.html?id=');
            $vTab->AddTableAction('новая запись',  'dynamic_edit.html');
...
//  $vView->form = $vRenderer->toObject();
    $vTemplate->compile('refs/dynamics.html');
