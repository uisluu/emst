...
*/
    ...
    class TData extends TBaseView
    {
        function GetTable()
        {
            ...
            $vTab =& new TTable('rb_doc_types', '*', '', 'name', 'id');
            $vTab->AddColumn('name',      'Наименование');
            $vTab->AddRowAction('изменить', 'doc_type_edit.html?id=');
            $vTab->AddTableAction('новая запись',  'doc_type_edit.html');
...
//  $vView->form = $vRenderer->toObject();
    $vTemplate->compile('refs/doc_types.html');
