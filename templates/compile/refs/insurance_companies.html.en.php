...
<html>
  <head>
    ...
    <title><?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'GetUserName'))) echo htmlspecialchars($t->GetUserName());?>: Администратор: Список страховых компаний</title>
  </head>
  ...
  <body>
    <table cellspacing="0" cellpadding="4">
      <tr>
        ...
        <td valign="top">
          <h1> Список страховых компаний </h1>
