...
<html>
  <head>
    ...
    <title><?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'GetUserName'))) echo htmlspecialchars($t->GetUserName());?>: Администратор: Создание/изменение описания манипуляции</title>
  </head>
        ...
        <td valign="top">
          <?php if ($this->options['strict'] || (isset($t->form) && method_exists($t->form, 'outputHeader'))) echo $t->form->outputHeader();?>
            ...
            <table class=maintable>
              <tr><th colspan="2"><?php echo $t->form->header->header;?></th></tr>
              <tr><td class="label"> <?php echo $t->form->name->label;?> </td><td class="control"> <?php echo $t->form->name->html;?> </td></tr>
              <tr><td class="label"> <?php echo $t->form->is_plaster->label;?></td><td class="control"> <?php echo $t->form->is_plaster->html;?></td></tr>

              <tr><td>&nbsp;</td><td align="right"><?php echo $t->form->Submit->html;?></td></tr>
            </table>
            <table>
