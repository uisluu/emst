...
<html>
  <head>
    ...
    <title><?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'GetUserName'))) echo htmlspecialchars($t->GetUserName());?>: Администратор: Создание/изменение описания категории</title>
  </head>
        ...
        <td valign="top">
          <?php if ($this->options['strict'] || (isset($t->form) && method_exists($t->form, 'outputHeader'))) echo $t->form->outputHeader();?>
            ...
            <table class=maintable>
              ...
              <tr>
               <td class="label"> <?php echo $t->form->need_ill_doc->label;?> </td>
               <td class="control"> <?php echo $t->form->need_ill_doc->html;?>  </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
