...
<html>
  <head>
    ...
    <title><?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'GetUserName'))) echo htmlspecialchars($t->GetUserName());?>: Врач: Список явок</title>
  </head>
        ...
        <td valign="top">
          ...
          <?php if ($this->options['strict'] || (isset($t->form) && method_exists($t->form, 'outputHeader'))) echo $t->form->outputHeader();?>
            ...
            <table class=maintable>
              ...
              <tr>
                <td class="label"> <?php echo $t->form->is_primary->label;?> </td>
                <td class="control"> <?php echo $t->form->is_primary->html;?>  </td>
                <td class="label"> <?php echo $t->form->empty_diagnosis_mkb->label;?> </td>
                <td class="control"> <?php echo $t->form->empty_diagnosis_mkb->html;?> </td>
                <td class="label"> &nbsp; </td>
                <td class="control"> &nbsp; </td>
              </tr>
              <tr>
                <td class="label"> <?php echo $t->form->is_bad_doc->label;?> </td>
                <td class="control"> <?php echo $t->form->is_bad_doc->html;?>  </td>
                <td class="label"> <?php echo $t->form->is_bad_illdoc->label;?> </td>
                <td class="control"> <?php echo $t->form->is_bad_illdoc->html;?>  </td>
                <td class="label"> &nbsp; </td>
                <td class="control"> &nbsp; </td>
              </tr>

              <tr>
                <td class="label"> <?php echo $t->form->eisoms_status->label;?> </td>
                <td class="control"> <?php echo $t->form->eisoms_status->html;?>  </td>
                <td class="label"> <?php echo $t->form->is_lost_outcome->label;?> </td>
                <td class="control"> <?php echo $t->form->is_lost_outcome->html;?>  </td>
                <td class="label"> &nbsp; </td>
                <td class="control"> &nbsp; </td>
              </tr>
