...
<html>
  <head>
    ...
    <title><?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'GetUserName'))) echo htmlspecialchars($t->GetUserName());?>: Врач: Изменение истории болезни</title>
            ...
            <?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'PageIs'))) if ($t->PageIs("BaseInfoPage")) { ?>
              <table class=maintable>
                ...
                <tr>
                  ...
                  <tr>
                    <td class="label"><?php echo $t->form->patient_polis_from->label;?></td><td class="control" colspan="2"> <?php echo $t->form->patient_polis_from->html;?></td>
                    <td class="label"><?php echo $t->form->patient_polis_to->label;?></td><td class="control" colspan="7"> <?php echo $t->form->patient_polis_to->html;?></td>
                  </tr>
                  <tr>
                      <td class="control" colspan="3"> <?php echo $this->elements['search_by_tfoms']->toHtml();?></td>
                  </tr>
                </tr>
