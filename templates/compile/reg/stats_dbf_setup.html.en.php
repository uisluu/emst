...
<html>
  <head>
    ...
    <title><?php if ($this->options['strict'] || (isset($t) && method_exists($t, 'GetUserName'))) echo htmlspecialchars($t->GetUserName());?>: Регистратура: Выгрузка стат.талонов для ЕИС ОМС</title>
  </head>
  ...
  <body>
    <table cellspacing="0" cellpadding="4">
      <tr>
        ...
        <td valign="top">
          <h1>Выгрузка стат.талонов для ЕИС ОМС</h1>
          <?php if ($this->options['strict'] || (isset($t->form) && method_exists($t->form, 'outputHeader'))) echo $t->form->outputHeader();?>
            ...
            <table class=maintable>
              ...
              <tr>
                <td class="label"> <?php echo $t->form->service->label;?> </td>
                <td class="control"> <?php echo $t->form->service->html;?>  </td>
              </tr>
              <tr>
